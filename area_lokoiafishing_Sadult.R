...
##This script tests loko ia area, loko ia fishing, & adult fish site fidelity.
...
write.csv(df, file='lokoiafishing_area_sitefidel_adult.csv')

outcome <- read.csv("lokoiafishing_area_sitefidel_adult.csv")
