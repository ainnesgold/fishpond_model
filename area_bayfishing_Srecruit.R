...
##This script tests loko ia area, bay fishing, & recruit fish site fidelity.
...
write.csv(df, file='fishing_area_sitefidel.csv')

outcome <- read.csv("fishing_area_sitefidel.csv")
